...
public final class NongLiTool {
    ...
    public static String getWenDao(int year, int month, int day,int hour) {
        String tem=getLunar(""+year,""+month,""+day);
        LogTool.s(tem);
        String s2=""+ cyclical(getYearCyl()) + "年 "+(getIsLeap() ? "闰" : "")+monthNong[getMonth()] + "月"+cDay(getDay()) + " "+getShiCheng(hour);
        return s2;
    }
    public static void main(String[] args) {
        System.out.println(getLunar("1990", "1", "27"));
        System.out.println(getLunar("2008", "6", "8"));
        System.out.println(getLunar("2009", "4", "3"));
        System.out.println(getLunar("2017", "7", "24"));
        for(int i=0;i<24;i++){
            System.out.println(" "+i+"  "+getShiCheng(i));
        }
    }
}