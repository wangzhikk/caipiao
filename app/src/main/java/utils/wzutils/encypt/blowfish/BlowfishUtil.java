package utils.wzutils.encypt.blowfish;
...
public class BlowfishUtil {
    ...
    public static void main(String[] args) {
        String keyString = "LoGjq55JVmV0aBz";
        String str = "phoneExist";
        BlowfishUtil crypt = new BlowfishUtil(keyString);
        String tempStr = crypt.encryptString(str);
        System.out.println(tempStr);
        System.out.println(crypt.decryptString("77521a97b7f1c84c68b0c36b8813f8ff3d6ddabac219c140786b010c0eceb40b"));
    }
